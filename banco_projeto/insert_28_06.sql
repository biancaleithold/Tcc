...
('26.356.309/0001-02', 'Brasil Noivas e Debutantes', 'São Paulo', '480', 'Casa', 'Bucarein', 'Joinville', 'Loja especializada na locação de trajes de noivas e debutantes, a mais de 30 anos no mercado. Contamos com profissionais de alto nível para realizar seus sonhos. Exclusividade nas marcas CENTER NOIVAS e NOVA NOIVA, com as coleções mais atuais do mercado. Trabalhamos também com estilista própria, NELIZE BRASIL, designer de moda especialista em alta costura.', '(47)3013-0800', 'brasilnoivas2018@gmail.com'),
('70.617.469/0001-50', 'Confeitaria Predileta', '  Hannah Mendes', '105', 'Casa', 'Floresta', 'São Paulo', 'A Confeitaria Sonhos foi inaugurada no dia 28 de agosto de 1984, desde então vem sendo a Confeitaria predileta dos habitantes de Joinville e região, fornecendo 200 tipos de sabores de bolos e os melhores doces típicos da região de Santa Catarina. Trabalhamos com qualquer tipo de evento, temos uma equipe rápida e competente, capaz de trabalhar com pequenos e grandes eventos.', '(47)3444-1125', 'confeitaria_predileta@gmail.com'),
...
('Corporativo','O fim de um ano, a comemoração de uma data especial ou a celebração de projeto é de muita alegria, é o momento para agradecer, aos familiares e aos colegas de trabalhos, então nada melhor que montar um evento para comemorar os desafios que superaram com a ajuda daqueles que nunca te deixaram sozinho, que sempre estiveram ao seu lado, independente do dia e do tempo, celebrar após um dever cumprido te da forças para continuar em frente nos próximos anos, venha montar seu evento conosco, celebrar com os amigos e familiares é a melhor forma de se divertir.', 'corporativa1.jpg', 'corporativa2.jpg', 'corporativa3.jpg', 'corporativa4.png'),
